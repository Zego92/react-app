          ...
          return (
            ...
            (t.prototype.setValue = function (t) {
              if (this._value !== t) {
                ...
                e &&
                  ((this._value = t), this._jqTitle.html(e.html), this.change())
              }
            }),
              ...
              if (
                ...
                if (p.options)
                  ...
                  ;(0 === p.min || p.min) && x.push(l(p.min)),
                    ...
                    this.bindControl(
                      new b(k, this._property.inputs[C], x, !1, this.model(), m)
                    ),
                    k.addClass("ticker"),
                    isFinite(p.step) &&
                      p.step > 0 &&
      ...
      inherit(L, n),
        ...
        (L.prototype._prepareLayoutForPlot = function (t, e) {
          ...
          if (a) {
            ...
            P.on("change", this._trackPriceLine.bind(this)).appendTo(k),
              ...
              this.bindControl(
                new l(w, o.plottype, parseInt, !0, this.model(), r)
              ),
              this.bindControl(
        ...
        (L.prototype._prepareLayoutForShapesPlot = function (t, e) {
          ...
          if (
            ...
            var w = v(g)
            this.bindControl(
              new c(w, o.color, !0, this.model(), r, o.transparency)
            )
          }
        }),
        ...
        (L.prototype._prepareLayoutForPalette = function (t, e, i, o, n, a) {
          ...
          for (var b in i.colors) {
            ...
            if (
              (this.bindControl(
                new c(g, f.color, !0, this.model(), n, p.transparency)
              ),
              ...
              if ((P.appendTo(C), 0 === y)) {
                ...
                L.appendTo(P),
                  this.bindControl(
                    new l(L, p.plottype, parseInt, !0, this.model(), n)
                  )
                var x = $("<td>")
                x.appendTo(C)
