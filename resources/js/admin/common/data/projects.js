...
const projects = [
  {
    ...
    files: [
      { name: "NeuroQuant Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "NeuroQuant Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "NeuroQuant Logo.Zip", size: "2.02 MB", link: "#" },
